...
class ImageFrame(wx.Frame):
    """
    MatPlotlib 2D plot as a wx.Frame, using ImagePanel
    """
...
Matt Newville <newville@cars.uchicago.edu>"""
    ...
    def display(self,x,**kw):
        """plot after clearing current plot """        
        self.imagepanel.display(x,**kw)
        
    def odisplayy(self,x,**kw):
        """generic plotting method, overplotting any existing plot """
        self.imagepanel.display(x,**kw)

    def plot(self,x,y,**kw):
        """plot after clearing current plot """        
        self.imagepanel.plot(x,y,**kw)
        
    def oplot(self,x,y,**kw):
        """generic plotting method, overplotting any existing plot """
        self.imagepanel.oplot(x,y,**kw)

    def update_line(self,t,x,y,**kw):
        """overwrite data for trace t """
        self.imagepanel.update_line(t,x,y,**kw)

    def set_xylims(self,xylims,**kw):
        """overwrite data for trace t """
        self.imagepanel.set_xylims(xylims,**kw)

    def get_xylims(self):
        """overwrite data for trace t """
        return self.imagepanel.get_xylims()
    ...
    def unzoom_all(self,event=None):
        ...
        self.imagepanel.unzoom_all(event=event)

    def unzoom(self,event=None):
        """zoom out 1 level, or to full data range """
        self.imagepanel.unzoom(event=event)
        
    def set_title(self,s):
        "set plot title"
        self.imagepanel.set_title(s)
        
    def set_xlabel(self,s):
        "set plot xlabel"        
        self.imagepanel.set_xlabel(s)

    def set_ylabel(self,s):
        "set plot xlabel"
        self.imagepanel.set_ylabel(s)        

    def save_figure(self,event=None):
        """ save figure image to file"""
        self.imagepanel.save_figure(event=event)

    def configure(self,event=None):
        self.imagepanel.configure(event=event)
    ...
    def __BuildFrame(self, size=(700,450), **kwds):
        ...
        self.imagepanel = ImagePanel(self, self.parent)
        self.imagepanel.messenger = self.write_message
        ...
        sizer.Add(self.imagepanel, 1, wx.EXPAND)
    ...
    def __BuildMenu(self):
        ...
        ppanel = self.imagepanel
        pcanvas = self.imagepanel.canvas
    ...
    def onExit(self, event=None):
        try:
            ...
            pass
        try:
            self.imagepanel.win_config.Close(True)
            self.imagepanel.win_config.Destroy()            
        except:
            pass
